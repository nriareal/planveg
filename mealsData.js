...
const allMeals = {
    ...
    snacks: [
        ...
        { name: "Protein Smoothie", cuisine: "Western", calories: 130, protein: 8, cookingTime: "5 mins", ingredients: [{item: "plant protein powder", quantity: 15, unit: "g"}, {item: "plant milk", quantity: 150, unit: "ml"}, {item: "banana", quantity: 100, unit: "g"}, {item: "spinach", quantity: 20, unit: "g"}], instructions: 'Blend plant protein powder, preferred plant milk, banana, and spinach until smooth.' },
        { name: "Mixed Nuts & Dried Fruit", cuisine: "Western", calories: 180, protein: 6, cookingTime: "1 min", ingredients: [{item: "mixed nuts", quantity: 30, unit: "g"}, {item: "dried fruit", quantity: 20, unit: "g"}], instructions: 'Combine mixed nuts and dried fruit for a quick snack.' },
        { name: "Apple with Almond Butter", cuisine: "Western", calories: 150, protein: 6, cookingTime: "5 mins", ingredients: [{item: "apple", quantity: 150, unit: "g"}, {item: "almond butter", quantity: 20, unit: "g"}, {item: "cinnamon", quantity: 2, unit: "g"}], instructions: 'Slice an apple and spread almond butter on the slices. Sprinkle with cinnamon.' },
...
const ingredientCategories = {
    ...
    'Nuts & Seeds': ['hemp seeds', 'nuts', 'almonds', 'walnuts', 'cashews', 'almond butter', 'tahini', 'pumpkin seeds', 'pine nuts', 'sesame seeds', 'peanuts', 'peanut butter', 'ground flax', 'sliced almonds'],
    'Plant Milks & Alternatives': ['almond milk', 'coconut milk', 'cashew cream', 'soy milk', 'oat milk', 'plant milk', 'coconut yogurt', 'vegan mayo', 'yogurt alternative', 'ghee alternative', 'soy yogurt', 'vegan butter', 'coconut cream'],
